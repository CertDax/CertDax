...
{patchShell === 'bash'
  ...
  : `kubectl patch secret certdax-operator-operator-token -n certdax-system -p '{\\"data\\":{\\"operator-token\\":\\"${btoa(newToken)}\\"}}'; kubectl rollout restart deployment certdax-operator -n certdax-system`}
              </pre>
              <button
